...
.modal-content{background:linear-gradient(180deg,var(--glass),transparent),var(--panel);border:1px solid var(--ring);border-radius:var(--radius);box-shadow:var(--shadow);max-width:1200px;width:95%;min-width:320px;height:auto;min-height:300px;max-height:90vh;overflow-y:auto;padding:24px;position:relative;animation:slideIn .3s ease;margin:16px}

@media (min-width: 1400px) {
  .modal-content{max-width:1400px;width:80%}
}
...
.bu-list{display:grid;grid-template-columns:repeat(auto-fill,minmax(200px,1fr));gap:16px}
.bu-card{padding:16px;border:1px solid var(--ring);border-radius:10px;background:var(--bg-2);cursor:pointer;transition:.2s;position:relative}
...
@media (min-width: 1200px) {
  .bu-list{grid-template-columns:repeat(auto-fill,minmax(250px,1fr))}
}
...
.app-table{width:100%;border-collapse:collapse;margin-top:16px;table-layout:auto}
.app-table th{text-align:left;padding:12px 8px;border-bottom:1px solid var(--ring);font-size:13px;color:var(--muted);font-weight:700}
.app-table td{padding:12px 8px;border-bottom:1px solid var(--ring);font-size:14px}
.app-table tr:hover{background:var(--ring)}
.app-table input[type=text],.app-table input[type=number],.app-table select{appearance:none;background:var(--bg-2);border:1px solid var(--ring);color:var(--text);padding:6px 8px;border-radius:6px;font-size:13px;width:100%}
.app-table input:focus,.app-table select:focus{outline:none;border-color:var(--primary);box-shadow:0 0 8px rgba(91,157,255,.3)}

/* Responsive table */
@media (min-width: 1200px) {
  .app-table th, .app-table td {padding: 14px 12px}
}
@media (max-width: 768px) {
...
.btn-primary{appearance:none;background:var(--primary);border:none;color:white;padding:12px 20px;border-radius:8px;cursor:pointer;font-weight:600;font-size:14px;transition:.2s}
.btn-primary:hover{filter:brightness(1.1)}
.btn-secondary{appearance:none;background:var(--bg-2);border:1px solid var(--ring);color:var(--text);padding:12px 20px;border-radius:8px;cursor:pointer;font-weight:600;font-size:14px;transition:.2s}
.btn-secondary:hover{background:var(--ring)}
.btn-danger{appearance:none;background:var(--danger);border:none;color:white;padding:12px 20px;border-radius:8px;cursor:pointer;font-weight:600;font-size:14px;transition:.2s}
.btn-danger:hover{filter:brightness(1.1)}
.btn-sm{padding:6px 10px;font-size:12px}

@media (max-width: 768px) {
  .btn-group {justify-content: center; gap: 8px}
  .btn-primary, .btn-secondary, .btn-danger {width: 100%; padding: 10px 16px; font-size: 13px}
}